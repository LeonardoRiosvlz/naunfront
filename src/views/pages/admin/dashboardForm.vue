  ...
  <Layout>
    ...
    <div class="d-lg-flex mb-4">
                ...
                <b-tab title="Tab 1" active>
                  ...
                  <b-card-text>
                          ...
                          <simplebar style="max-height: 345px" id="scrollElement">
                              ...
                              >
                                  <a href="javascript: void(0);" @click="valorDoc=data.archivo">
      ...
      <b-modal id="nuevo" false size="lg"  title="Acciones a realizar" hide-footer>
        ...
        <!-- EDITAR VERSIOENS -->
        <b-modal id="modal" false size="lg"  title="Gestion de formatos" hide-footer>
        ...
        <b-modal id="modal-padre" false size="lg"  title="Gestion de documento actual" hide-footer>
          ...
          <!-- CREAR VERSIONES -->
           <b-modal id="modal-obsoleto" false size="lg"  title="Gestion de formatos obsoletos" hide-footer>
             <div  class="row justify-content-center align-items-center position-absolute" style="z-index:0;     width: 100%;  padding-top: 5rem;"> 
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="20rem" height="20rem" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg); max-width:25rem; filter: opacity(0.3) grayscale(33) saturate(0.9);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 34 32"><g fill="#62626233"><path d="M1.512 28H19.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227L13.853.147a.507.507 0 0 0-.289-.135C13.543.01 13.523 0 13.5 0H1.506C.676 0 0 .673 0 1.5v25c0 .827.678 1.5 1.512 1.5zM14 1.707L19.293 7H14.5a.5.5 0 0 1-.5-.5V1.707zM1 1.5c0-.276.227-.5.506-.5H13v5.5c0 .827.673 1.5 1.5 1.5H20v18.5a.5.5 0 0 1-.5.5H1.512A.506.506 0 0 1 1 26.5v-25z"/><path d="M4.5 12h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 16h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 8h5a.5.5 0 0 0 0-1h-5a.5.5 0 0 0 0 1z"/><path d="M4.5 20h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 24h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M21.5 5H26v5.5c0 .827.673 1.5 1.5 1.5H33v18.5a.5.5 0 0 1-.5.5H14.512a.506.506 0 0 1-.512-.5v-1a.5.5 0 0 0-1 0v1c0 .827.678 1.5 1.512 1.5H32.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227l-6.999-6.999a.491.491 0 0 0-.289-.134C26.543 4.01 26.523 4 26.5 4h-5a.5.5 0 0 0 0 1zm6 6a.5.5 0 0 1-.5-.5V5.707L32.293 11H27.5z"/><path d="M23.5 16h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 20h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 24h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 28h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/></g></svg>
            </div>
            <ValidationObserver style="z-index:1; position: relative;" ref="form">
          ...
          <!-- CREAR VERSIONES -->
        <b-modal id="modal-crea" false size="lg"  title="Gestion de formatos" hide-footer>
          <div  class="row justify-content-center align-items-center position-absolute" style="z-index:0;     width: 100%;  padding-top: 5rem;"> 
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="20rem" height="20rem" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg); max-width:25rem; filter: opacity(0.3) grayscale(33) saturate(0.9);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 34 32"><g fill="#62626233"><path d="M1.512 28H19.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227L13.853.147a.507.507 0 0 0-.289-.135C13.543.01 13.523 0 13.5 0H1.506C.676 0 0 .673 0 1.5v25c0 .827.678 1.5 1.512 1.5zM14 1.707L19.293 7H14.5a.5.5 0 0 1-.5-.5V1.707zM1 1.5c0-.276.227-.5.506-.5H13v5.5c0 .827.673 1.5 1.5 1.5H20v18.5a.5.5 0 0 1-.5.5H1.512A.506.506 0 0 1 1 26.5v-25z"/><path d="M4.5 12h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 16h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 8h5a.5.5 0 0 0 0-1h-5a.5.5 0 0 0 0 1z"/><path d="M4.5 20h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 24h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M21.5 5H26v5.5c0 .827.673 1.5 1.5 1.5H33v18.5a.5.5 0 0 1-.5.5H14.512a.506.506 0 0 1-.512-.5v-1a.5.5 0 0 0-1 0v1c0 .827.678 1.5 1.512 1.5H32.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227l-6.999-6.999a.491.491 0 0 0-.289-.134C26.543 4.01 26.523 4 26.5 4h-5a.5.5 0 0 0 0 1zm6 6a.5.5 0 0 1-.5-.5V5.707L32.293 11H27.5z"/><path d="M23.5 16h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 20h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 24h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 28h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/></g></svg>
          </div>
            <ValidationObserver style="z-index:1; position: relative;" ref="form">
        ...
        <b-modal id="modal-nueva" false size="lg"  title="Gestion de formatos" hide-footer>
          <div  class="row justify-content-center align-items-center position-absolute" style="z-index:0;     width: 100%;  padding-top: 5rem;"> 
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="20rem" height="20rem" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg); max-width:25rem; filter: opacity(0.3) grayscale(33) saturate(0.9);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 34 32"><g fill="#62626233"><path d="M1.512 28H19.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227L13.853.147a.507.507 0 0 0-.289-.135C13.543.01 13.523 0 13.5 0H1.506C.676 0 0 .673 0 1.5v25c0 .827.678 1.5 1.512 1.5zM14 1.707L19.293 7H14.5a.5.5 0 0 1-.5-.5V1.707zM1 1.5c0-.276.227-.5.506-.5H13v5.5c0 .827.673 1.5 1.5 1.5H20v18.5a.5.5 0 0 1-.5.5H1.512A.506.506 0 0 1 1 26.5v-25z"/><path d="M4.5 12h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 16h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 8h5a.5.5 0 0 0 0-1h-5a.5.5 0 0 0 0 1z"/><path d="M4.5 20h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 24h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M21.5 5H26v5.5c0 .827.673 1.5 1.5 1.5H33v18.5a.5.5 0 0 1-.5.5H14.512a.506.506 0 0 1-.512-.5v-1a.5.5 0 0 0-1 0v1c0 .827.678 1.5 1.512 1.5H32.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227l-6.999-6.999a.491.491 0 0 0-.289-.134C26.543 4.01 26.523 4 26.5 4h-5a.5.5 0 0 0 0 1zm6 6a.5.5 0 0 1-.5-.5V5.707L32.293 11H27.5z"/><path d="M23.5 16h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 20h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 24h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 28h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/></g></svg>
          </div>
        ...
        <b-modal id="modal_hab" false size="lg"  title="Gestion de formatos" hide-footer>
          <div  class="row justify-content-center align-items-center position-absolute" style="z-index:0;     width: 100%;  padding-top: 5rem;"> 
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="20rem" height="20rem" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg); max-width:25rem; filter: opacity(0.3) grayscale(33) saturate(0.9);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 34 32"><g fill="#62626233"><path d="M1.512 28H19.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227L13.853.147a.507.507 0 0 0-.289-.135C13.543.01 13.523 0 13.5 0H1.506C.676 0 0 .673 0 1.5v25c0 .827.678 1.5 1.512 1.5zM14 1.707L19.293 7H14.5a.5.5 0 0 1-.5-.5V1.707zM1 1.5c0-.276.227-.5.506-.5H13v5.5c0 .827.673 1.5 1.5 1.5H20v18.5a.5.5 0 0 1-.5.5H1.512A.506.506 0 0 1 1 26.5v-25z"/><path d="M4.5 12h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 16h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 8h5a.5.5 0 0 0 0-1h-5a.5.5 0 0 0 0 1z"/><path d="M4.5 20h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M4.5 24h12a.5.5 0 0 0 0-1h-12a.5.5 0 0 0 0 1z"/><path d="M21.5 5H26v5.5c0 .827.673 1.5 1.5 1.5H33v18.5a.5.5 0 0 1-.5.5H14.512a.506.506 0 0 1-.512-.5v-1a.5.5 0 0 0-1 0v1c0 .827.678 1.5 1.512 1.5H32.5c.827 0 1.5-.673 1.5-1.5v-19c0-.023-.01-.043-.013-.065a.426.426 0 0 0-.013-.062a.488.488 0 0 0-.122-.227l-6.999-6.999a.491.491 0 0 0-.289-.134C26.543 4.01 26.523 4 26.5 4h-5a.5.5 0 0 0 0 1zm6 6a.5.5 0 0 1-.5-.5V5.707L32.293 11H27.5z"/><path d="M23.5 16h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 20h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 24h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/><path d="M23.5 28h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0 0 1z"/></g></svg>
          </div>
            <ValidationObserver style="z-index:1; position: relative;" ref="form">
         ...
         await this.axios.post('api/documentos/find',data)
           .then((response) => {
              if (response.status==200) {
                ...
                this.edit.documento_actual.vformatos = null
              }
           })
           .catch((e)=>{
             console.log('error' + e);
         ...
         await this.axios.post('api/formatos/find',data)
           .then((response) => {
              ...
              if (response.status==200) {
                this.edit.documento_actual = response.data
                console.log(this.edit)
                this.docs_Habilitados = this.edit.documento_actual.hformatos
              }
           })
           .catch((e)=>{
             console.log('error' + e);
   ...
   async listarperfil(){
     ...
     data.append('cliente_id',this.cliente.id);
      ...
      async listardocscreados(){
        let data = new FormData();
        data.append('cliente_id',this.cliente.id);
          await this.axios.post('api/formatos/listar',data)
            .then((response) => {
    ...
    elaborar(){
     ...
     var formulario = this.edit;
      ...
      if (this.diagrama) {
       ...
       await this.axios.post('api/formatos/versiones/elaborar', data, {
           headers: {
     ...
     var formulario = this.edit;
      ...
      if (this.archivo && this.edit.status_aprobacion == 'Aprobado') {
       ...
       await this.axios.post('api/formatos/versiones/aprobar', data, {
           headers: {
            'Content-Type': 'multipart/form-data'
           }}).then(response => {
    ...
    async revisarDocumento(){
     ...
     var formulario = this.edit;
      ...
      if (this.diagrama) {
       ...
       await this.axios.post('api/formatos/versiones/revisar', data, {
           headers: {
            'Content-Type': 'multipart/form-data'
           }}).then(response => {
     ...
     var formulario = this.edit;
      for (var key in formulario) {
       ...
       await this.axios.post('api/formatos/versiones/habilitar', data, {
           headers: {
            'Content-Type': 'multipart/form-data'
           }}).then(response => {
    ...
    switchLocD(){
      if (!this.editMode) {
        ...
        await this.axios.post('api/formatos/versiones/obsoleta', data, {
          headers: {
          'Content-Type': 'multipart/form-data'
          }}).then(response => {
            if (response.status==200) {
    ...
    async editarPadre(estado){
      ...
      if (this.logo ) {
        ...
        await this.axios.put('api/formatos', data, {
          headers: {
          'Content-Type': 'multipart/form-data'
          }}).then(response => {
            if (response.status==200) {
  ...
  async agregarDocumento(){
   ...
   async edicionVersionHabilitada(){
     let data = new FormData();
      ...
      console.log(formulario)
       await this.axios.post('api/formatos/versiones/editversionando', data, {
           headers: {
            'Content-Type': 'multipart/form-data'
           }}).then(response => {
            if (response.status==200) {
      ...
      async eliminarVersions(id){
        let data = new FormData();
        data.append('id',id);
        await this.axios.post('api/formatos/version/delete',data, {
            headers: {
              'Content-Type': 'multipart/form-data'
            }}).then(response => {
              if (response.status==200) {
      ...
      async buscarVersiones(){
        let data = new FormData();
         data.append('documento_id',this.$route.params.id);
          await this.axios.post('api/formatos/versiones/listar',data)
            .then((response) => {
        ...
        async agregarversion(){
          let data = new FormData();
            ...
            await this.axios.post('api/formatos/versiones', data, {
                headers: {
                  'Content-Type': 'multipart/form-data'
                }}).then(response => {
                  if (response.status==200) {
          ...
          await this.axios.put('api/formatos/versiones', data, {
            headers: {
            'Content-Type': 'multipart/form-data'
            }}).then(response => {
              if (response.status==200) {
     ...
     async setear(index){
       ...
       data.append('id',index);
         await this.axios.post('api/formatos/versiones/find',data)
           .then((response) => {
