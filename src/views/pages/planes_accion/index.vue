<template>
  <Layout>
                  ...
                  <li v-for="mejora in filteredItems"  :key="mejora.di" v-if="mejora.acciones.length==0">
                      <div class="media align-items-center pl-4">
                        ...
                        <div class="media-body p-0">
                          ...
                          <button class="btn btn-success btn-sm  ml-1" @click="setear_mejora(mejora.id)">Programar <i class="ri-time-line"></i></button>
                        </div>
                      </div>
                      <hr>
                  </li>
                      ...
                      >
                        ...
                        <b-dropdown size="sm" class="">
                          <template v-slot:button-content>
                            ...
                            <b-dropdown-item-button @click="editMode=true;ver=false;setearAccion(data.item.id)"><b-icon icon="pencil" class=""></b-icon> Editar </b-dropdown-item-button>
                            <b-dropdown-item-button @click="eliminarAccionC(data.item.id)"><b-icon icon="trash" class=""></b-icon> Eliminar </b-dropdown-item-button>
                            <b-dropdown-item-button ><b-icon icon="eye" class=""></b-icon><a :href="'/plan-accion/'+data.item.id" style="color:#000">Notificar</a></b-dropdown-item-button>
                        </b-dropdown>
                        </template>
                      </b-table>
                    </div>
    ...
    <b-row>
      ...
      <b-modal id="modal_acciones" false size="lg"  title="Acciones" hide-footer>
