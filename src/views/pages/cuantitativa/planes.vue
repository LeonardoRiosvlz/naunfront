   ...
   async agregarbases(){
     let data = new FormData();
      var formulario = this.form;
       ...
       await this.axios.post('api/autoevaluacion/cuantitativa', data, {
           headers: {
    ...
    async editarbases(){
     let data = new FormData();
       var formulario = this.form;
        ...
        await this.axios.put('api/autoevaluacion/cuantitativa', data).then(response => {
            if (response.status==200) {
     ...
     async eliminarbasess(id){
        let data = new FormData();
        data.append('id',id);
        await this.axios.post('api/autoevaluacion/cuantitativa/delete',data, {
            headers: {
              'Content-Type': 'multipart/form-data'
            }}).then(response => {
              if (response.status==200) {
    ...
    async listarbases(){
     ...
     data.append('cliente_id',this.cliente.id);
       await this.axios.post('api/autoevaluacion/cuantitativa/listar',data)
        .then((response) => {
